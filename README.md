...
A fork of kartoza/docker-geoserver, modified to fit sat4envi requirements.
Most of the README.md is applicable to this fork and should work as described, however, I describe essentials in
a separate section.
...
Versions:
- GeoServer 2.15.0,
- community modules (s3-geotiff) taken from GeoServer build server from 2.15.x/community-latest,
- Tomcat 8.0.
